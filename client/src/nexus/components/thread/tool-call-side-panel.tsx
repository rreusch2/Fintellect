...
import { CircleDashed, X, ChevronLeft, ChevronRight, Computer, Terminal, Globe, Search, FileText } from 'lucide-react';
import { Button } from '../../components/ui/button.jsx';

// Utility function to combine class names
const cn = (...classes: any[]) => classes.filter(Boolean).join(' ');
  // Return appropriate icon component based on tool name
  return Computer;
};
...
// Define ApiMessageType interface
...
import { ToolView } from './tool-views/wrapper/index.tsx';
            ...
            {currentToolCall.toolResult?.content && !isStreaming && (
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                  <Computer className="h-3.5 w-3.5 text-zinc-800 dark:text-zinc-300" />
                </div>
                <span
                  className={cn(
            ...
            <div className="flex justify-between items-center gap-4">
              <div className="flex items-center gap-2 min-w-0">
                <div className="h-5 w-5 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                  <Computer className="h-3 w-3 text-zinc-800 dark:text-zinc-300" />
                </div>
                <span
